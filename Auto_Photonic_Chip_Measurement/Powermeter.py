	...
	def __init__(self, *args, **kwargs):
		...
		for r in resources:
			if self.serial in r.split('::'):
				...
				print('Connected to Thorlabs PM100D with serial no. {} at: {:}'.format(self.serial, pm_serial))
	...
	def measure(self, channel = 1):
		...
		if os.name == 'posix':
			...
			if self.unit == 'W':
				...
				return (10 * math.log( result_W * 1000, 10) ) if result_W > 0 else result_W#float('nan')
