...
def exterior_algebra_max_information_2d(data_point,point_delta,order=3):
...
def exterior_algebra_max_information_3d(data_point,data_point_value,point_delta,order=[3,3]):
...
def exterior_algebra_max_information_and_max_information_and_max_information_4d(data_point,data_point_value_1,data_point_value_2,data_point_value_3,point_delta,order=[3,3,3]):

    fit_point_1 = BS.fit_4d(data_point,data_point_value_1,point_delta,order)
    fit_point_2 = BS.fit_4d(data_point,data_point_value_2,point_delta,order)
    fit_point_3 = BS.fit_4d(data_point,data_point_value_3,point_delta,order)
    ...
    for n1 in range(len_fit_point_1-1):
        ...
        for n2 in range(len_fit_point_2-1):
            ...
            for n3 in range(len_fit_point_3-1):
                ...
                vector[0][0] = fit_point_3[0][n1]-data_point[0][i1]
                vector[0][1] = vector[0][0]
                vector[0][2] = vector[0][0]
                vector[0][3] = vector[0][0]
                vector[0][4] = fit_point_3[0][n1]-data_point[0][i1+1]
                vector[0][5] = vector[0][4]
                vector[0][6] = vector[0][4]
                vector[0][7] = vector[0][4]
                vector[1][0] = fit_point_3[1][n2]-data_point[1][i2]
                vector[1][1] = vector[1][0]
                vector[1][2] = fit_point_3[1][n2]-data_point[1][i2+1]
                vector[1][3] = vector[1][2]
                vector[1][4] = vector[1][0]
                vector[1][5] = vector[1][0]
                vector[1][6] = vector[1][2]
                vector[1][7] = vector[1][2]
                vector[2][0] = fit_point_3[2][n3]-data_point[2][i3]
                vector[2][1] = fit_point_3[2][n3]-data_point[2][i3+1]
                vector[2][2] = vector[2][0]
                vector[2][3] = vector[2][1]
                vector[2][4] = vector[2][0]
                vector[2][5] = vector[2][1]
                vector[2][6] = vector[2][0]
                vector[2][7] = vector[2][1]
                vector[3][0] = fit_point_3[3][n1][n2][n3]-data_point_value_3[i1][i2][i3]
                vector[3][1] = fit_point_3[3][n1][n2][n3]-data_point_value_3[i1][i2][i3+1]
                vector[3][2] = fit_point_3[3][n1][n2][n3]-data_point_value_3[i1][i2+1][i3]
                vector[3][3] = fit_point_3[3][n1][n2][n3]-data_point_value_3[i1][i2+1][i3+1]
                vector[3][4] = fit_point_3[3][n1][n2][n3]-data_point_value_3[i1+1][i2][i3]
                vector[3][5] = fit_point_3[3][n1][n2][n3]-data_point_value_3[i1+1][i2][i3+1]
                vector[3][6] = fit_point_3[3][n1][n2][n3]-data_point_value_3[i1+1][i2+1][i3]
                vector[3][7] = fit_point_3[3][n1][n2][n3]-data_point_value_3[i1+1][i2+1][i3+1]
                    ...
                    for vector_2 in range(vector_1+1,6):
                        ...
                        for vector_3 in range(vector_2+1,7):
                            ...
                            for vector_4 in range(vector_3+1,8):
                                ...
                                weight_3 = weight_3+abs(np.linalg.det(matrix))
