...
def exterior_algebra_max_value_3d(data_point_1,data_point_2,data_point_value,point_delta,level):
...
def LRHBS_sample_point_add_3d(data_point_1,data_point_2,new_point,point_delta,level):
    ...
    while (loop_status):
        ...
        if (level > data_point_value_position[0]):
            ...
            if (data_point_value_position[2] < 2 or data_point_value_position[3] > len(data_point_1[l][b])-2 or (data_point_value_position[4] < 2 or data_point_value_position[5] > len(data_point_2[l][b])-2)):
