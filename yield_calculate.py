...
def yield_calculate_3d_2(parameter_1,parameter_1_delta,parameter_1_variance,parameter_2,parameter_2_delta,parameter_2_variance,parameter_3,parameter_3_delta,parameter_3_variance,performance_1,performance_condition_1,performance_2,performance_condition_2):
                ...
                for j1 in range(2*number_dif_1+1):
                    ...
                    for j2 in range(2*number_dif_2+1):
                        ...
                        for j3 in range(2*number_dif_3+1):
                            ...
                            if (performance_1[i1+j1][i2+j2][i3+j3] >= performance_condition_1 and performance_2[i1+j1][i2+j2][i3+j3] >= performance_condition_2):
...
def yield_calculate_3d_3(parameter_1,parameter_1_delta,parameter_1_variance,parameter_2,parameter_2_delta,parameter_2_variance,parameter_3,parameter_3_delta,parameter_3_variance,performance_1,performance_condition_1,performance_2,performance_condition_2,performance_3,performance_condition_3):
                ...
                for j1 in range(2*number_dif_1+1):
                    ...
                    for j2 in range(2*number_dif_2+1):
                        ...
                        for j3 in range(2*number_dif_3):
                            ...
                            if (performance_1[i1+j1][i2+j2][i3+j3] >= performance_condition_1 and performance_2[i1+j1][i2+j2][i3+j3] >= performance_condition_2 and performance_condition_3[0] <= performance_3[i1+j1][i2+j2][i3+j3] <= performance_condition_3[1]):
...
def yield_calculate_3d_range(parameter_1,parameter_1_delta,parameter_1_variance,parameter_2,parameter_2_delta,parameter_2_variance,parameter_3,parameter_3_delta,parameter_3_variance,performance,performance_condition):
                ...
                for j1 in range(2*number_dif_1+1):
                    ...
                    for j2 in range(2*number_dif_2+1):
                        ...
                        for j3 in range(2*number_dif_3+1):
                            ...
                            if (performance_condition[0] <= performance[i1+j1][i2+j2][i3+j3] <= performance_condition[1]):
